...
export interface GreenSpace { id: string; name: string; type: SpaceType; address: string; neighborhood: string; latitude: number | null; longitude: number | null; status: MaintenanceStatus; created_at: string; updated_at: string; source_type?: string | null; surface_m2?: number | null; section_code?: string | null; source_document?: string | null; source_key?: string | null }
