...
export function RelocationEditor({ space, draft, busy, error, onSave, onClose }: { space: SpaceRecord; draft?: { latitude: number; longitude: number }; busy: boolean; error: string; onSave: () => void; onClose: () => void }) {
