...
export default function SpaceMap({ spaces, selected, onSelect, locationMode = false, draftLocation, onLocationPick }: { spaces: SpaceRecord[]; selected?: SpaceRecord; onSelect: (space: SpaceRecord) => void; locationMode?: boolean; draftLocation?: { latitude: number; longitude: number }; onLocationPick?: (lat: number, lng: number) => void }) {
